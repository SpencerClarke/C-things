...
<ol>
    ...
    <li>A trie that can store a bunch of strings and pair them with ints. The integer value can then be retrieved for any given string. There is also functionality to remove nodes and destroy the tree.<a href="Datastructs/Trie">here</a></li>
</ol>
</p>
