...
<ol>
    ...
    <li>Okay so, I know this is gonna sound bad but, hear me out. This is a sort of linked list that sits in shared memory, where each node is a value and the id of the shared memory segment that contains the next node. Don't ever use this. <a href="Datastructs/SharedLinkedLists"> here</a></li>
